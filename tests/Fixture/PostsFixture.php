...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'description' => ['type' => 'text', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'published' => 1,
                'created' => '2020-04-28 18:39:16',
                'modified' => '2020-04-28 18:39:16',
            ],
        ];
        parent::init();
    }
